<template>
  <div class="white-gradient flex flex-col items-center justify-center">
    <div class="flex flex-row w-full max-w-6xl py-6 justify-between relative"
      ...
      <n-link to="/dashboard/referrals"
              class="py-1 px-4 rounded-full text-gdp bg-opaqueIndigo text-sm font-bold leading-tight mx-8 cursor-pointer flex items-center justify-center hover:border-gdp border-2 border-opaqueIndigo">
        Refer a friend and get $10!
      </n-link>
      <n-link to="/dashboard/upgrade"
              class="py-1 px-4 rounded-full text-gdp bg-opaqueIndigo text-sm font-bold leading-tight mx-8 cursor-pointer flex items-center justify-center hover:border-gdp border-2 border-opaqueIndigo">
        Upgrade and go pro!
      </n-link>
    </div>
            ...
            <div class="flex flex-row items-center justify-start flex-wrap" style="max-width:300px;">
              <div class="mb-1">
                ...
                <span
                  ...
                  class="font-bold text-lg opacity-60"
                >singlel.ink/u/{{ user.activeProfile.handle }}</span>
              </div>
              <div
